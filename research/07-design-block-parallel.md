...
> ⚠️ **이 문서의 근사(블록 독립 인코딩) 노선은 정확도 검증에서 기각됐다.**
> 최종 설계는 [09-design-ring-cp.md](09-design-ring-cp.md) 다.
>
> 다만 여기의 측정과 분석(토큰 축 선택 근거, 스케일링 모델, 블록 크기 하한,
> 깊이 분해 기각)은 그대로 유효하며 09 의 토대가 된다.
> 기각 경위는 [09 §2](09-design-ring-cp.md) 참조.
