...
## 5.2 진단 — 비용은 pack 연산이 아니라 cache footprint 다
...
## 5.3 해법 — pack 을 executor op 로 승격
...
그런데 **이 상태에서 E2E 로짓 해시가 BASE 와 비트 단위로 일치해 통과했다.**

> **출력 해시는 커널 정확성의 검증기가 아니다.**
